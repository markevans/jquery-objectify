(function(){
  ...
  // objectifyPlugin defines a new jquery 'plugin' method using the name passed in
  //
  // e.g. $.objectifyPlugin('hello', ...) is equivalent to
  //      $.fn.hello = function(){ ... }
  //
  ...
  //
  //
  $.objectifyPlugin = function(name, opts){
    ...
    $.fn[name] = function(){
      ...
      $(this).each(function(i){
        ...
        obj.elem = elem; // Make the elem available for use in methods via 'this.elem'

        code_block(elem, obj, i);
